...
class GameTest extends TestCase
{
    ...
    public function test__game_init(): void
    {
        ...
        $game = new Game($players, self::NUMBER_OF_ROUNDS);
    ...
    public function test__game_init_with_invalid_player(): void
    {
        ...
        new Game($players, self::NUMBER_OF_ROUNDS);
    }

    public function test__save_throw(): void
    {
        $game = new Game($this->short_valid_list_players, self::NUMBER_OF_ROUNDS);
        $game->save_throw(5);
    ...
    {
        $game = new Game([new Player("Player 1")], self::NUMBER_OF_ROUNDS);
        $game->save_throw(1);
        $game->save_throw(1);

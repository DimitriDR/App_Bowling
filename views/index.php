...
<main class="container mx-auto border rounded-md px-10 py-5 mt-6">
    ...
    <h1 class="text-4xl text-center font-semibold">Création d'une partie</h1>
        <form method="POST" action="/controllers/index.php" class="grid grid-cols-1 gap-4 content-center mx-auto mt-5 mb-5">
            <div class="flex flex-wrap justify-center">
                <div class="w-full md:w-1/3 px-3 mb-6">
                    <input class="mt-2 mx-auto w-80 block rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" name="player_number" id="player_number" placeholder="Saisir le nombre de joueurs" min="1" max="20" required autofocus>
                </div>
                <div class="w-full md:w-1/3 px-3 mb-6">
                    <input class="mt-2 mx-auto w-80 block rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" name="pin_number" id="pin_number" placeholder="Saisir le nombre de quilles" min="1" required autofocus>
                </div>
                <div class="w-full md:w-1/3 px-3 mb-6">

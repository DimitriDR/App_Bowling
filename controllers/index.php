...
if (!is_numeric($_POST["player_number"]))
{
    ...
    header(REDIRECT_URL);
} elseif(!is_numeric($_POST["pin_number"]))
{
    $_SESSION["error_message"] = "Le nombre de quilles saisi n'est pas un nombre entier.";
    header(REDIRECT_URL);
} elseif(!is_numeric($_POST["rounds"]))
{
...
// On stocke temporairement le nombre de joueurs dans la partie, le nombre de rounds et de tours
